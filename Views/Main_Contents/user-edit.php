  ...
  <body>
    ...
    <div class="wrapper bg-light">
      <div class="content">
        ...
        <form id="user-edit" class="m-5" action="" method="post">
          <table id="user-input_table" class="table table-bordered table-hover">
            <!-- 氏名 -->
            <tr>
              <th>氏名<span class="p-2 text-danger">必須</span></th>
              <td>
                <input type="text" name="last_name" value="<?php if($_POST){echo $user['last_name'];}else{echo $_SESSION['User']['last_name'];} ?>" placeholder="苗字" autofocus>
                <input type="text" name="first_name" value="<?php if($_POST){echo $user['first_name'];}else{echo $_SESSION['User']['first_name'];} ?>" placeholder="名前" class="ml-3">
                <!--入力に不備があった場合、不備内容を表示-->
                <br>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="last_name_kana" value="<?php if($_POST){echo $user['last_name_kana'];}else{echo $_SESSION['User']['last_name_kana'];} ?>" placeholder="苗字(フリガナ)">
                <input type="text" name="first_name_kana" value="<?php if($_POST){echo $user['first_name_kana'];}else{echo $_SESSION['User']['first_name_kana'];} ?>" placeholder="名前(フリガナ)" class="ml-3">
                <!--入力に不備があった場合、不備内容を表示-->
                <br>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="email" value="<?php if($_POST){echo $user['email'];}else{echo $_SESSION['User']['email'];} ?>" placeholder="メールアドレス">
                <!--入力に不備があった場合、不備内容を表示-->
                <br>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="tel" value="<?php if($_POST){echo $user['tel'];}else{echo $_SESSION['User']['tel'];} ?>" placeholder="電話番号(ハイフンなし)">
                <!--入力に不備があった場合、不備内容を表示-->
                <br>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="postcode" value="<?php if($_POST){echo $user['postcode'];}else{echo $_SESSION['User']['postcode'];} ?>" placeholder="郵便番号(ハイフンなし)">
            ...
            <tr>
              ...
              <td>
                <input type="text" name="city" value="<?php if($_POST){echo $user['city'];}else{echo $_SESSION['User']['city'];} ?>" placeholder="市区町村">
                <!--入力に不備があった場合、不備内容を表示-->
                <br>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="block" value="<?php if($_POST){echo $user['block'];}else{echo $_SESSION['User']['block'];} ?>" placeholder="番地">
                <!--入力に不備があった場合、不備内容を表示-->
                <br>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="building" value="<?php if($_POST){echo $user['building'];}else{echo $_SESSION['User']['building'];} ?>" placeholder="建物名">
                <!--入力に不備があった場合、不備内容を表示-->
                <br>
          ...
          <button id="user-edit_complete" class="btn btn-primary btn-block" type="submit">確認</button>
        </form>
    ...
    <script>
      ...
      function prefecture_id() {
        $('#prefecture_id').val('<?php if($_POST){echo $user['prefecture_id'];}else{echo $_SESSION['User']['prefecture_id'];} ?>');
      }
    </script>
